-- ============================================================
-- CAMPUSCONNECT — ZERO-DENOMINATOR ATTENDANCE FIX
--
-- Replaces the currently deployed notification generator.
-- Students with zero counted classes, such as an Excused-only
-- history, must not receive a false 0% low-attendance warning.
-- ============================================================
